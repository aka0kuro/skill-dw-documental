...
class DocumentaryCentralSkill(OVOSCommonPlaybackSkill):
    def __init__(self, *args, **kwargs):
        ...
        self.skill_icon = join(dirname(__file__), "ui", "DWDocumental.jpg")
        self.archive = JsonStorageXDG("DWDocumental", subfolder="OCP")
    ...
    def get_playlist(self, score=50, num_entries=25):
        ...
        return {
            ...
            "title": "DW Documental (Documentary Playlist)",
            "author": "DW Documental"
        }
